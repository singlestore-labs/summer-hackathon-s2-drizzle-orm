...
const config = {
  "generator": {
    ...
    "output": {
      "value": "/home/prodrigues/Desktop/summer-hackathon-s2-drizzle-orm/integration-tests/tests/prisma/pg/client",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
  ...
  "inlineDatasources": {
    "db": {
      "url": {
        "fromEnvVar": "PG_CONNECTION_STRING",
        "value": null
      }
    }
  },
  "inlineSchema": "generator client {\n  provider = \"prisma-client-js\"\n  output   = \"./client\"\n}\n\ngenerator drizzle {\n  provider = \"drizzle-prisma-generator\"\n  output   = \"./drizzle\"\n}\n\ndatasource db {\n  provider = \"postgresql\"\n  url      = env(\"PG_CONNECTION_STRING\")\n}\n\nmodel User {\n  id    Int     @id @default(autoincrement())\n  email String  @unique\n  name  String?\n}\n",
  "inlineSchemaHash": "c0d2427a6d727687e6b27b2e90867eb6aea914674b3e96b5bb3dced1fe6fecee",
  "copyEngine": true
}
...
path.join(process.cwd(), "tests/prisma/pg/client/libquery_engine-debian-openssl-3.0.x.so.node")
// file annotations for bundling tools to include these files
path.join(__dirname, "schema.prisma");
path.join(process.cwd(), "tests/prisma/pg/client/schema.prisma")
