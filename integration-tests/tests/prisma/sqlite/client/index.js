...
const config = {
  "generator": {
    ...
    "output": {
      "value": "/home/prodrigues/Desktop/summer-hackathon-s2-drizzle-orm/integration-tests/tests/prisma/sqlite/client",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
...
path.join(process.cwd(), "tests/prisma/sqlite/client/libquery_engine-debian-openssl-3.0.x.so.node")
// file annotations for bundling tools to include these files
path.join(__dirname, "schema.prisma");
path.join(process.cwd(), "tests/prisma/sqlite/client/schema.prisma")
