...
path.join(process.cwd(), "tests/prisma/mysql/client/libquery_engine-debian-openssl-3.0.x.so.node")
// file annotations for bundling tools to include these files
path.join(__dirname, "schema.prisma");
path.join(process.cwd(), "tests/prisma/mysql/client/schema.prisma")
